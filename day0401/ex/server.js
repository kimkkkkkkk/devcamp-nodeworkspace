...
자체적인 능력이 한계가 있다. 하지만 모듈을 통해서 엄청난 확장성을
갖고 있다. (*전세계 개발자들에 의해 모듈이 오픈소스로 공유된다.)
*/

// 모듈이 뭔데?
//http 등의 모듈은 이미 node.js 설치시 함께 포함이 된다. 이러한 내장된 모듈을
//가리켜 내장 모듈이라 한다.. 어딘가 내장이 되어있음

//기본적인 웹서버 모듈 가져오기
var http = require("http"); //-> 자바스크립트 소스 , 내장모듈, 웹에대한 관련성이 느껴져야함

//우리가 정의한 나만의 모듈도 가져와보자!! (객체취급)
...
//네트워크 프로그램을간 식별을 위한 구분 고유값 1~1024 사이의 포트번호는 시스템이
//이미 사용중인 포트이므로, 피해야 한다.. ex) 21 FTP 
//또한 사용 프로그램이 이미 사용중인 포트도 피하자!! oracle-1521 , mysql-3306
//mssql - 1433,
